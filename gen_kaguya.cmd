...
..\..\_schemacrawler\schemacrawler.cmd --server=sqlite "--database=%REPO_PATH%\kaguya_data.db" --user=sa --password= --info-level=maximum -c=schema --output-format=png "-o=%REPO_PATH%\schema.png"
